...
cc<-read.csv("/Users/seimandijuliette/Documents/efrei/M2/Deep learning/General/abide.cc.bvol.20150118/abide.cc.area.csv",sep=",") 
# read in brain volume
bvol <-read.csv("/Users/seimandijuliette/Documents/efrei/M2/Deep learning/General/abide.cc.bvol.20150118/abide.brain.vol.csv",sep=",",h=F)
names(bvol)[2] <- "bvol.mm"

# read in phenotypic data
demo <-read.csv("/Users/seimandijuliette/Documents/efrei/M2/Deep learning/General/abide.cc.bvol.20150118/Phenotypic_V1_0b.csv",sep=",") 

# read in QA assessments
qa <-read.csv("/Users/seimandijuliette/Documents/efrei/M2/Deep learning/General/abide.cc.bvol.20150118/abide_scan_rating.csv",sep=",")
...
df <- cc.bvol.demo.qa
write.csv(df, "C:\\Users\\seimandijuliette\\Bureau\\cc_bvol_demo.qa.csv", row.names = FALSE)
...
directory <-getwd()
directory
write.csv(df, "cc_bvol_demo.qa.csv")
